...
|---|---|---:|---|---:|---|
| `J1` | `AC IN` | 5 | White board connector at lower left | high | User confirmed all wires come from the main transformer. Pin 5 is closest to the bottom PCB edge. Pins 1-2 yellow, pin 3 grey, pins 4-5 brown. |
...
| CRT neck connector | CRT socket | 7 | Pins: 1 green/E1, 2 yellow/E2, 3 brown/E3, 4 black/J2-aquadag, 5 NC, 6 red/E6, 7 blue/E7. Loose black clip is continuous to J2. | high for wiring, low for electrode function | Electrode mapping still requires CRT type/pinout. |
...
- What are the CRT socket electrode functions for pads `E1`, `E2`, `E3`, `E6`, and `E7`?
- What is the CRT tube type and socket pinout?

## Pad Map Status

`pad_map.csv` has rows for `J1`, `J2`, and `J4`. `J2` is user-confirmed as earth/aquadag. `J1` is user-confirmed as a 5-pin main-transformer harness; diode-node mapping is still pending.
